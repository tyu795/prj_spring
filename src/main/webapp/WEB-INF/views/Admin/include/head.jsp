...
<head>
    ...
    <title>SomBNB</title>
    <link rel="shortcut icon" type="image/png" sizes="192x192" href="/resources/img/android-icon-192x192.png">
    <link rel="shortcut icon" type="image/png" sizes="32x32" href="/resources/img/favicon-32x32.png">
    <link rel="shortcut icon" type="image/png" sizes="16x16" href="/resources/img/favicon-16x16.png">
