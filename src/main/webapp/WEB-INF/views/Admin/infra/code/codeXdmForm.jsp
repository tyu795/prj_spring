                ...
                <c:choose>
                 <c:when test="${empty item.seq }">
                    <div class="mainLabelBox">
                        ...
                        <div class="addBox" onclick="location.href='/codeXdmList'">
...
<%--script code--%>
    <script>
        ...
        $(".updateBtn").on("click",function(){
            $("form[name=updateForm]").attr("action","/codeUpdt").submit();
        });
        /*생성버튼 이벤트*/
        $(".insertBtn").on("click",function(){
            $("form[name=insertForm]").attr("action","/codeInst").submit();
        });
        /*삭제버튼 이벤트*/
        $(".deleteBtn").on("click",function(){
            $("form[name=updateForm]").attr("action","/codeDele").submit();
        });
