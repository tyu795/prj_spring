    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>코드 관리</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>멤버 관리</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/memberList">
              <i class="bi bi-circle"></i><span>멤버 테이블</span>
            </a>
          </li>
          <li>
	...
	<!-- $(list) 자바에서 넘겨준 객체 이름 --> <!-- var="list" jst1블럭에서 사용할 변수 이름 -->
		<c:forEach items="${list}" var="list" varStatus="status">
		          <tr>
                    ...
                    <td><a href="memberXdmForm?seq=<c:out value="${list.seq }"/>"><c:out value="${list.name }"/></a></td>
              ...
              <!-- End Table with stripped rows -->
				...
				<a href="memberXdmForm"><button type="button" class="btn btn-primary" id="btn">Add</button></a>
            </div>
          </div>
        </div>
      </div>
