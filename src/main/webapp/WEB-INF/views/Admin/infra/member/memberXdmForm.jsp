	...
	<c:otherwise>
	           <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="id" id="name" value="<c:out value="${item.id }"/>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Pw</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pw" id="name" value="<c:out value="${item.pw }"/>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Email</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="email" id="name" value="<c:out value="${item.email }"/>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">DelNy</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="delNy" id="name" value="<c:out value="${item.delNy }"/>">
                  </div>
                </div>
                <div class="row mb-3">
